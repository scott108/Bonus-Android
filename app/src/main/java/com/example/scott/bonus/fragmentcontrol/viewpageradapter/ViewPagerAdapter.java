package com.example.scott.bonus.fragmentcontrol.viewpageradapter;
...
public class ViewPagerAdapter extends FragmentStatePagerAdapter {
    ...
    public Fragment getItem(int position) {
        ...
        {
            InvoiceExchangedFragment invoiceExchangedFragment = new InvoiceExchangedFragment();
            return invoiceExchangedFragment;
        }
